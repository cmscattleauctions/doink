...
export function PrivacyPolicy({ onBack }) {
  return (
    <LegalShell title="Privacy Policy" onBack={onBack}>
      ...
      <P>This Privacy Policy explains how DOINK collects, uses, stores, and protects information when you use the DOINK mobile app.</P>
      <P>DOINK is a fictional play-chip card strategy game. DOINK does not offer real-money gambling, cash-out, prizes, or anything with real-world monetary value.</P>
      <P>By using DOINK, you agree to the practices described in this Privacy Policy.</P>

      <H>1. Information We Collect</H>
      <P>DOINK may collect the following types of information.</P>
      ...
      <P><b>Device and Technical Information.</b> DOINK may collect basic technical information needed to operate, secure, and improve the app, such as device type, operating system, app version, error logs, crash reports, and general usage information. If analytics or crash-reporting tools are added, they may collect diagnostic information to help identify bugs and improve performance.</P>
      ...
      <P>DOINK may use third-party authentication services such as Firebase Authentication, Google Sign-In, or Sign in with Apple. When you sign in through one of these services, DOINK may receive basic account information such as your email address, display name, and user ID. Your sign-in provider may also collect and process information according to its own privacy policy.</P>

      <H>4. Game Data and Leaderboards</H>
      <P>DOINK may store gameplay-related data so your progress can be saved and restored. If leaderboard features are enabled, your display name, score, level, fictional chip count, or other gameplay ranking information may be visible to other users.</P>
      ...
      <P>DOINK uses fictional play chips only. Fictional chips, levels, unlocks, leaderboard scores, achievements, and other in-game items have no cash value, cannot be redeemed for money, cannot be exchanged for prizes, cannot be transferred outside the app, and do not represent real-money gambling activity.</P>

      <H>6. Third-Party Services</H>
      <P>DOINK may use third-party services to operate the app, including Firebase Authentication, Firebase Firestore or other Firebase database services, Google Sign-In, Sign in with Apple, and Firebase or Google diagnostic services if enabled. These services may process information according to their own privacy policies and terms.</P>
      ...
      <P>We keep account and game data for as long as needed to provide DOINK's features. If you delete your account or request account deletion, we will delete or anonymize associated account data unless retention is required for legal, security, fraud-prevention, or legitimate operational reasons. Some backup copies or logs may remain for a limited time before being deleted through normal system processes.</P>

      <H>9. Account and Data Deletion</H>
      <P>You may request deletion of your DOINK account and associated data by contacting {SUPPORT_EMAIL} with the subject line "DOINK Account Deletion Request." Please include the email address associated with your DOINK account. We may ask for verification before deleting account data. Deletion requests will generally be processed within {DELETION_TIMEFRAME}.</P>

      <H>10. Children's Privacy</H>
      <P>DOINK is not intended for children. We do not knowingly collect personal information from children under the age required by applicable law. If you believe a child has provided personal information to DOINK, contact us at {SUPPORT_EMAIL} and we will take appropriate action.</P>
...
export function TermsOfUse({ onBack }) {
  return (
    <LegalShell title="Terms of Use" onBack={onBack}>
      ...
      <P>These Terms of Use govern your use of the DOINK mobile app. By downloading, accessing, or using DOINK, you agree to these Terms. If you do not agree, do not use the app.</P>

      <H>1. About DOINK</H>
      <P>DOINK is a fictional play-chip card strategy game. The app may include Quick Play mode, Career mode, computer-controlled opponents, fictional chip balances, levels and progression, unlockable options, leaderboards, cloud saves, and customization features. DOINK is designed for entertainment only.</P>

      <H>2. Fictional Play-Chip Gameplay Only</H>
      <P>DOINK uses fictional play chips. Fictional chips, points, scores, levels, unlocks, achievements, rankings, and other in-game items have no real-world monetary value, cannot be redeemed for money, cannot be exchanged for prizes, cannot be sold, cannot be transferred outside the app, and do not represent ownership of any financial asset.</P>

      <H>3. No Real-Money Gambling</H>
      <P>DOINK is not a real-money gambling app. The app does not allow users to deposit real money for wagering, win real money, cash out fictional chips, redeem chips for prizes, participate in real-money contests, or exchange in-game items for anything of real-world value.</P>
      ...
      <P>We may update, modify, suspend, or discontinue any part of DOINK at any time. We do not guarantee that all features will always be available, error-free, or compatible with every device. Some features may require internet access.</P>

      <H>9. Intellectual Property</H>
      <P>DOINK, including its name, design, gameplay elements, artwork, text, graphics, code, branding, and other content, is owned by or licensed to the developer. You may not copy, distribute, modify, sell, or use DOINK content except as allowed by these Terms or applicable law.</P>
      ...
      <H>11. Disclaimer</H>
      <P>DOINK is provided "as is" and "as available." We do not guarantee that the app will be uninterrupted, secure, bug-free, or free from data loss. To the maximum extent allowed by law, we disclaim warranties of merchantability, fitness for a particular purpose, and non-infringement.</P>

      <H>12. Limitation of Liability</H>
      <P>To the maximum extent allowed by law, the developer will not be liable for indirect, incidental, special, consequential, or punitive damages arising from your use of DOINK. Because DOINK does not offer real-money gambling, prizes, or cash-out, no user is entitled to payment, compensation, or redemption based on fictional chips, scores, or game progress.</P>

      <H>13. Account Deletion</H>
      <P>You may request deletion of your account and associated data by contacting {SUPPORT_EMAIL} with the subject line "DOINK Account Deletion Request." We may ask you to verify the account before deletion.</P>

      <H>14. Changes to These Terms</H>
      <P>We may update these Terms from time to time. If changes are material, we may notify users through the app, store listing, or another appropriate method. Continued use of DOINK after updated Terms are posted means you accept the updated Terms.</P>
...
export function AccountDeletion({ onBack }) {
  return (
    <LegalShell title="Account Deletion" onBack={onBack}>
      <P>You may request deletion of your DOINK account and associated data at any time.</P>
      <P>DOINK may use account sign-in through Firebase Authentication, Google Sign-In, or Sign in with Apple. Your account may be connected to saved game progress, fictional chip balances, leaderboard information, settings, and unlocks.</P>

      <H>What Will Be Deleted</H>
      <P>When your account deletion request is completed, we will delete or anonymize account-related data associated with your DOINK account, which may include:</P>
      <UL>
        <LI>Email address</LI>
        <LI>Display name</LI>
        <LI>User ID</LI>
      ...
      <P>Some information may be retained for a limited time if necessary for security, fraud prevention, abuse investigation, legal compliance, backup or system recovery processes, or aggregated/anonymized analytics. Any retained information will be handled according to the DOINK Privacy Policy.</P>

      <H>How to Request Account Deletion</H>
      <P>To request account deletion, email {SUPPORT_EMAIL} with the subject line "DOINK Account Deletion Request." Please include the email address used for your DOINK account, your display name if applicable, and a short statement that you want your DOINK account deleted.</P>
      <P>Example message: "I would like to delete my DOINK account and associated data. Account email: [your account email]. Display name: [your display name]."</P>
...
export function SupportPage({ onBack }) {
  return (
    <LegalShell title="Support" onBack={onBack}>
      <P>Need help with DOINK? Contact support at {SUPPORT_EMAIL}.</P>
      ...
      <P>To request account deletion, email {SUPPORT_EMAIL} with the subject line "DOINK Account Deletion Request." Include the email address connected to your DOINK account.</P>

      <H>Important Gameplay Notice</H>
      <P>DOINK is a fictional play-chip card strategy game. DOINK does not offer real-money gambling, cash-out, prizes, redeemable chips, or anything with real-world monetary value. All chips, scores, unlocks, and rankings are fictional and for entertainment only.</P>
